...
class AMMJSON(typing.TypedDict):
    ...
    market_position_per_lp: perp_position.PerpPositionJSON
...
class AMM:
    layout: typing.ClassVar = borsh.CStruct(
        ...
        "market_position_per_lp" / perp_position.PerpPosition.layout,
    ...
    market_position_per_lp: perp_position.PerpPosition
    ...
    def from_decoded(cls, obj: Container) -> "AMM":
        return cls(
            ...
            market_position_per_lp=perp_position.PerpPosition.from_decoded(
                obj.market_position_per_lp
            ),
    ...
    def to_encodable(self) -> dict[str, typing.Any]:
        return {
            ...
            "market_position_per_lp": self.market_position_per_lp.to_encodable(),
    ...
    def to_json(self) -> AMMJSON:
        return {
            ...
            "market_position_per_lp": self.market_position_per_lp.to_json(),
    ...
    def from_json(cls, obj: AMMJSON) -> "AMM":
        return cls(
            ...
            market_position_per_lp=perp_position.PerpPosition.from_json(
                obj["market_position_per_lp"]
            ),
